...
namespace RequireInterfaceAttribute
{
    ...
    /// </summary>
    [CustomPropertyDrawer(typeof(global::RequireInterfaceAttribute.RequireInterfaceAttribute))]
    ...
    public class RequireInterfaceDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (property.propertyType == SerializedPropertyType.ObjectReference)
            {
                ...
                var requiredAttribute = this.attribute as global::RequireInterfaceAttribute.RequireInterfaceAttribute;
