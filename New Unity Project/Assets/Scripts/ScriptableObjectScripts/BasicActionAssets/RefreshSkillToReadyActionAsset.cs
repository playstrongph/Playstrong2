...
{
    [CreateAssetMenu(fileName = "RefreshSkillToReadyAction", menuName = "Assets/BasicActions/R/RefreshSkillToReadyAction")]
    public class RefreshSkillToReadyActionAsset : BasicActionAsset
    {
        /// <summary>
        /// Target skill
        /// </summary>
        ...
        public override IEnumerator ExecuteAction(IHero casterHero,IHero targetHero)
        {
            ...
            RefreshSkillToReady(targetHero);
            
            logicTree.EndSequence();
            yield return null;
        }

        private void RefreshSkillToReady(IHero targetHero)
        {
            ...
            if (targetSkill != null)
            {
                targetSkill.SkillLogic.UpdateSkillCooldown.RefreshCooldownToZero();
            }
