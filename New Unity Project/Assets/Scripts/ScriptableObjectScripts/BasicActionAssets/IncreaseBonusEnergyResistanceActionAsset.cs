...
{
    [CreateAssetMenu(fileName = "IncreaseBonusEnergyResistanceAction", menuName = "Assets/BasicActions/I/IncreaseBonusEnergyResistanceAction")]
    public class IncreaseBonusEnergyResistanceActionAsset : BasicActionAsset
    {   
        /// <summary>
        ...
        /// <summary>
        /// Increase target hero's bonus energy resistance 
        /// </summary>
        /// <param name="casterHero"></param>
        /// <param name="targetHero"></param>
        /// <returns></returns>
        public override IEnumerator ExecuteAction(IHero casterHero,IHero targetHero)
        {
            ...
            targetHero.HeroLogic.ResistanceAttributes.BonusEnergyResistance += flatValue;
