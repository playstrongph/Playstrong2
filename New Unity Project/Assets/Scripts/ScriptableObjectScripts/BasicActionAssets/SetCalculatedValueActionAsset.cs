...
{
    [CreateAssetMenu(fileName = "SetCalculatedValueAction", menuName = "Assets/BasicActions/S/SetCalculatedValueAction")]
    public class SetCalculatedValueActionAsset : BasicActionAsset
    {
        ...
        public override IEnumerator ExecuteAction(IHero casterHero,IHero targetHero)
        {
            ...
            CalculatedValueAsset.GetCalculatedValue(targetHero);
