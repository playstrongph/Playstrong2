...
{
    [CreateAssetMenu(fileName = "IncreaseCriticalDamage", menuName = "Assets/BasicActions/I/IncreaseCriticalDamage")]
    public class IncreaseCriticalDamageActionAsset : BasicActionAsset
    {   
        /// <summary>
        /// Increase value by a fixed amount
        /// </summary>
        [SerializeField] private int flatValue = 50;
        ...
        public override IEnumerator ExecuteAction(IHero casterHero,IHero targetHero)
        {
            ...
            targetHero.HeroLogic.DamageAttributes.CriticalDamage += flatValue;
