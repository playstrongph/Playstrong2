...
{
    [CreateAssetMenu(fileName = "IncreaseBuffResistanceAction", menuName = "Assets/BasicActions/I/IncreaseBuffResistanceAction")]
    public class IncreaseBuffResistanceActionAsset : BasicActionAsset
    {   
        /// <summary>
        ...
        public override IEnumerator ExecuteAction(IHero casterHero,IHero targetHero)
        {
            ...
            targetHero.HeroLogic.ResistanceAttributes.BuffResistance += flatValue;
