...
{
    [CreateAssetMenu(fileName = "AfterHeroChangesHealthEvent", menuName = "Assets/BasicEvents/AfterHeroChangesHealthEvent")]

    public class AfterHeroChangesHealthEventAsset : BasicEventAsset
    {
        /// <summary>
